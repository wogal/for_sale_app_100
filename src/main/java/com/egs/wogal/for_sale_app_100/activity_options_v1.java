...
public class activity_options_v1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // sound record / play Dialog_ItemName
        mBut_Sound_Play = (Button) findViewById(R.id.But_sound_play_v3);
     //   mBut_Sound_Play.setOnClickListener(this);

        mBut_Sound_Record = (Button) findViewById(R.id.But_sound_record_v3);
        ...
        if (1 == 1) {
            switch (v.getId()) {
                ...
                case R.id.But_item_voice_v1:{ // SOUND RECORDER
                    ...
                    mViewItemName = getLayoutInflater().inflate(R.layout.layout_v3, null);
                    mBut_Sound_Play.setOnClickListener(this);
                    mBuilder.setView(mViewItemName);
                    Dialog_ItemName = mBuilder.create();
                ...
                case R.id.But_item_name_v1: {
                    ...
                    mTxtEnterdTextField_v2 = (TextView) mViewItemName.findViewById(text_view_sales_item_name_v2);
